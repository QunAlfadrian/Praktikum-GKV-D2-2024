...
GLuint _textureId1, _textureId2, _textureId3, _textureId4, _textureId5, _textureId6; //ID OpenGL untuk tekstur
...
glutCreateWindow("Texture With Image - Qun Alfadrian");
initRendering();
